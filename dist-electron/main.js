...
function setupDatabase() {
    return __awaiter(this, void 0, void 0, function () {
        var userDataPath, dbDir, dbPath;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    userDataPath = electron_1.app.getPath('userData');
                    dbDir = (0, path_1.join)(userDataPath, 'database');
                    // 데이터베이스 폴더가 없으면 생성
                    if (!(0, fs_1.existsSync)(dbDir)) {
                        (0, fs_1.mkdirSync)(dbDir, { recursive: true });
                    }
                    dbPath = (0, path_1.join)(dbDir, 'scenably.db');
                    // 환경변수 설정
                    process.env.DATABASE_URL = "file:".concat(dbPath);
...
electron_1.app.whenReady().then(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_1 = _a.sent();
                console.error('앱 초기화 실패:', error_1);
